...
async function main() {
  ...
  app.use((req, res, next) => {
    ...
    const allowedOrigins = ['http://localhost:8081', 'http://localhost:19006', 'https://paintwiser.app', 'https://www.paintwiser.app', 'https://app.paintwiser.app', 'http://147.135.15.155:3002'];
